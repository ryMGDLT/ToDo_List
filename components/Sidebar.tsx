...
import { ChartBarIcon, CheckCircleIcon, Cog6ToothIcon } from "@heroicons/react/24/outline";
...
export default function Sidebar() {
  ...
  return (
    <div suppressHydrationWarning className={`w-64 ${resolvedTheme === 'dark' ? 'bg-gradient-to-b from-slate-900 to-slate-800 text-white' : 'bg-gradient-to-b from-slate-100 to-slate-200 text-slate-900'} h-screen fixed left-0 top-0 shadow-2xl`}>
      <div suppressHydrationWarning className={`p-6 border-b ${resolvedTheme === 'dark' ? 'border-slate-700' : 'border-slate-300'}`}>
